...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('purchases/reports', [PurchaseController::class, 'reports'])->name('purchases.report'); // Singular 'report'
    Route::post('purchases/reports', [PurchaseController::class, 'generateReport']); // Match sales pattern
